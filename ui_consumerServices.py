...
"}")
        ...
        self.allTable.setSortingEnabled(True)
        self.allTable.setRowCount(20)
        ...
        self.spectateTable.setSortingEnabled(True)
        self.spectateTable.setRowCount(20)
        ...
        self.consultationTable.setSortingEnabled(True)
        self.consultationTable.setRowCount(20)
        ...
        self.lectureTable.setSortingEnabled(True)
        self.lectureTable.setRowCount(20)
